...
total_horas = input('Quantas horas por dia você dedica aos estudos? ')
...
print(f'Olá {nome}, você costuma estudar {total_dias} dias por semana, durante {total_horas} diárias, no curso {curso}. Durante uma média de {total_dias*total_horas}. Parabéns!!')